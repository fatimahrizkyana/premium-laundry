                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="type" id="type" class="form-control @error ('type') is-invalid @enderror" value="{{ old('type') }}" aria-describedby="helpId" autofocus>                                
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="price" id="price" class="form-control @error ('price') is-invalid @enderror" value="{{ old('price') }}" aria-describedby="helpId" autofocus>                                
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="discount" id="discount" class="form-control @error ('discount') is-invalid @enderror" value="{{ old('discount') }}" aria-describedby="helpId" autofocus>                                
